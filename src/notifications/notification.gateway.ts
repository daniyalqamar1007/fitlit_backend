...
export class NotificationGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleConnection(client: AuthenticatedSocket) {
    ...
    try {
      ...
      const token =
        (client.handshake.query.token as string) || client.handshake.headers.authorization?.replace("Bearer ", "")
  ...
  handleJoin(data: { userId?: number }, client: AuthenticatedSocket): void {
